...
function App() {
  ...
  return (
    <div className="h-full bg-gradient-to-b from-blue-50 to-white p-4 sm:p-8 flex flex-col justify-center items-center">
      <div className="w-full max-w-2xl space-y-6 flex flex-col items-center overflow-y-auto">
